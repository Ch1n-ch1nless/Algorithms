...
void TopSortComponent(const std::vector<std::vector<int>> &graph, std::vector<int> &order, std::vector<bool> &used, int vertex )
{
    used[vertex] = true;
...
void TopSortGraph(const std::vector<std::vector<int>> &graph, std::vector<int> &order )
{
...
void FindComponent(const std::vector<std::vector<int>> &graph, std::vector<int> &components, int comp_count,  int vertex)
{
...
int FindStronglyConnectedComponents(const std::vector<std::vector<int>> &graph, 
                                          ...
                                          std::vector<int>              &strongly_connected_components)
{
    ...
    for (int& vertex : vertex_order)
    {
        ...
        {
            components_count++;
            FindComponent(transposed_graph, strongly_connected_components, components_count, vertex);
        }
    }
...
int main()
{
    ...
    int components_number = FindStronglyConnectedComponents(graph, transposed_graph, strongly_connected_components);
